...
const data = {
  title:
    "We move your offline buisness and your idea to fully functionall digital solution.",
  description:
    "Get your buisness to next height, world is changing you should too, we also provide services in Web3 space.",
  ...
  points: [
    ...
    {
      icon: <IoIosCheckmarkCircle />,
      text: "Multi platform digital solution",
    },
  ],
};
