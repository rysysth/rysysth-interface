...
export default function ClientFeedback() {
  return (
    <section sx={{ variant: "section.feedback" }} id="feedback">
      <Container>
        <SectionHeader
          title="More than hundred of user we have worldwide with happy feedback"
          description="Focus only on your buisness, we will take care of digital side of your buisness."
        />
